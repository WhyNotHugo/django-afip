            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        help_text="The document number of the customer to whom this receipt is addressed",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="If left blank, the next valid number will assigned when validating the receipt.",
                        null=True,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Must be equal to the sum of net_taxed, exempt_amount, net_taxes, and all taxes and vats.",
                        max_digits=15,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="The total amount to which taxes do not apply. For C-type receipts, this must be zero.",
                        max_digits=15,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="The total amount to which taxes apply. For C-type receipts, this is equal to the subtotal.",
                        max_digits=15,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Only for categories which are tax-exempt. For C-type receipts, this must be zero.",
                        max_digits=15,
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date on which a service started. No applicable for goods.",
                        null=True,
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date on which a service ended. No applicable for goods.",
                        null=True,
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date on which this receipt expires. No applicable for goods.",
                        null=True,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=6,
                        default=1,
                        help_text="Quote of the day for the currency used in the receipt",
                        max_digits=10,
                ...
                (
                    "document_type",
                    models.ForeignKey(
                        help_text="The document type of the customer to whom this receipt is addressed",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="receipts",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="The observations as returned by the AFIP. These are generally present for failed validations.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_sandboxed",
                    models.BooleanField(
                        help_text="Indicates if this taxpayer interacts with the sandbox servers rather than the production servers",
                ...
                (
                    ...
                    models.DateTimeField(
                        editable=False,
                        help_text="Stores expiration for the current certificate. Note that this field is updated pre-save, so the value may be invalid for unsaved models.",
                        null=True,
                ...
                (
                    "active_since",
                    models.DateField(
                        help_text="Date since which this taxpayer has been legally active.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sales_terms",
                    models.CharField(
                        help_text="The terms of the sale printed onto receipts by default (eg: single payment, checking account, etc).",
                        max_length=48,
                        verbose_name="sales terms",
                    ),
                ),
