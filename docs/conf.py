...
#
# html_title = 'django-afip vVERSION'
...
htmlhelp_basename = 'django-afipdoc'
...
latex_documents = [
    (master_doc, 'django-afip.tex', 'django-afip Documentation',
...
man_pages = [
    (master_doc, 'django-afip', 'django-afip Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'django-afip', 'django-afip Documentation',
     author, 'django-afip', 'One line description of project.',
     'Miscellaneous'),
]
